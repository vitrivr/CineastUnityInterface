...
${nuget_cmd} install src/Org.Vitrivr.CineastApi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Org.Vitrivr.CineastApi.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Org.Vitrivr.CineastApi.dll \
-recurse:'src/Org.Vitrivr.CineastApi/*.cs' \
-doc:bin/Org.Vitrivr.CineastApi.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Org.Vitrivr.CineastApi.dll was created successfully"
fi
