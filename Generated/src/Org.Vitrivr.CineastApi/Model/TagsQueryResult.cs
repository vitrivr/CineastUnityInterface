...
namespace Org.Vitrivr.CineastApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TagsQueryResult :  IEquatable<TagsQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagsQueryResult" /> class.
        /// </summary>
        /// <param name="queryId">queryId.</param>
        /// <param name="tags">tags.</param>
        public TagsQueryResult(string queryId = default(string), List<Tag> tags = default(List<Tag>))
        {
        ...
        {
            return this.Equals(input as TagsQueryResult);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(TagsQueryResult input)
        {
            if (input == null)
                return false;
