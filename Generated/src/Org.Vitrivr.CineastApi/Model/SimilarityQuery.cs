...
namespace Org.Vitrivr.CineastApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SimilarityQuery :  IEquatable<SimilarityQuery>, IValidatableObject
    {
        /// <summary>
        /// Defines MessageType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimilarityQuery" /> class.
        /// </summary>
        /// <param name="containers">containers.</param>
        /// <param name="config">config.</param>
        /// <param name="components">components.</param>
        /// <param name="messageType">messageType.</param>
        public SimilarityQuery(List<QueryComponent> containers = default(List<QueryComponent>), QueryConfig config = default(QueryConfig), List<QueryComponent> components = default(List<QueryComponent>), MessageTypeEnum? messageType = default(MessageTypeEnum?))
        {
        ...
        public List<QueryComponent> Containers { get; set; }
        ...
        public List<QueryComponent> Components { get; set; }
        ...
        {
            return this.Equals(input as SimilarityQuery);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(SimilarityQuery input)
        {
            if (input == null)
                return false;
