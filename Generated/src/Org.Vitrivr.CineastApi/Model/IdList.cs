...
namespace Org.Vitrivr.CineastApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IdList :  IEquatable<IdList>, IValidatableObject
    {
        /// <summary>
        /// Defines MessageType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IdList" /> class.
        /// </summary>
        /// <param name="ids">ids.</param>
        /// <param name="messageType">messageType.</param>
        public IdList(List<string> ids = default(List<string>), MessageTypeEnum? messageType = default(MessageTypeEnum?))
        {
            this.Ids = ids;
        ...
        {
            return this.Equals(input as IdList);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(IdList input)
        {
            if (input == null)
                return false;
