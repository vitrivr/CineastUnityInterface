...
namespace Org.Vitrivr.CineastApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StartSessionMessage :  IEquatable<StartSessionMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines MessageType
        /// </summary>
        ...
        public StartSessionMessage(Credentials credentials = default(Credentials), MessageTypeEnum? messageType = default(MessageTypeEnum?))
        {
        ...
        {
            return this.Equals(input as StartSessionMessage);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(StartSessionMessage input)
        {
            if (input == null)
                return false;
