...
namespace Org.Vitrivr.CineastApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SimilarityQueryResult :  IEquatable<SimilarityQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Defines MessageType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimilarityQueryResult" /> class.
        /// </summary>
        ...
        public SimilarityQueryResult(List<StringDoublePair> content = default(List<StringDoublePair>), string queryId = default(string), string category = default(string), int containerId = default(int), MessageTypeEnum? messageType = default(MessageTypeEnum?))
        {
        ...
        public List<StringDoublePair> Content { get; set; }
        ...
        {
            return this.Equals(input as SimilarityQueryResult);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(SimilarityQueryResult input)
        {
            if (input == null)
                return false;
